	...
	<div class="random-form bg-white p-6 rounded-lg shadow-md w-full max-w-md">
		...
		<div class="flex flex-row space-x-1 mt-6">
			<button
				...
				class="w-full bg-emerald-600 hover:bg-emerald-700 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-bold py-2 px-4 rounded-lg transition-colors shadow-md flex items-center justify-center gap-2"
			>
				Seleccionar Todos
			</button>
			<button
